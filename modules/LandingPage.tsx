...
const LandingPage: React.FC = () => {
    ...
    const handleContactSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                showToast("¡Gracias por tu mensaje! Tu solicitud ha sido recibida. Un técnico de SuperAir te contactará en breve.", "success");
                setContactForm({ name: '', phone: '', service: 'Mantenimiento Preventivo' });
            } else {
                showToast("Hubo un error al enviar tus datos. Por favor intenta más tarde o llama directamente.", "error");
            }
        } catch (e) {
            console.error(e);
    ...
    const handleAppointmentSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                showToast(`¡Solicitud Recibida! Hemos agendado una pre-reserva para ${appointmentForm.name}. Te confirmaremos la hora exacta por WhatsApp al número ${appointmentForm.phone}.`, "success");
